...
Provider.create('localeProvider', function(app) {
    ...
    var langDirs = glob.sync(app.rootPath('lang/*'));
    ...
    function KeyStore()
    {
        ...
        this.setLocaleDir = function(dirName)
        {
            ...
            files.forEach(function(file)
            {
                ...
                app.logger.debug("Loaded Language File: %s.%s (%d keys)", localeName, file, index);
            });
        }
    ...
    app.event.on('view_create', function(view,request) {
